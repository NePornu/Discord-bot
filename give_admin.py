...
def main():
    guild_id = 1475546302405693440 # Training Ground
    ...
    cql_create_role = f"INSERT INTO fluxer.guild_roles (guild_id, role_id, name, permissions, position, color, hoist, mentionable, version) VALUES ({guild_id}, {role_id}, 'Admin', 8, 999, 0, false, false, 1);"
    
    # Add role to member
    # Note: role_ids is a set
