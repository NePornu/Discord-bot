...
- `ANALYTICS.md` – Redis HLL analytika: DAU/WAU/MAU, heavy-hitters, heartbeat.
- `LOGGING.md` – kompletní logging (2 log kanály, /log příkazy, perzistence).
- `REPORTS.md` – měsíční reporty (datové soubory, metriky, jak fungují).
