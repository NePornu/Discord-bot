...
async def global_exception_handler(request: Request, exc: Exception):
    ...
    <h2>Internal Server Error Debugger (Main)</h2>
...
# Removed scenario generator (Ollama no longer needed)
...
async def startup_event():
    if APP_MODE == "training":
        ...
        # Ollama scenario generation removed.
...
async def _dashboard_logic(request: Request, start_date: str = None, end_date: str = None, role_id: str = None):
    ...
    if not perms:
        try:
             ...
             # AI Evaluator removed (Ollama no longer needed)
