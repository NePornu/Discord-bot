...
async def load_commands():
    ...
    for filename in os.listdir(commands_dir):
        ...
        is_module = filename.endswith(".py")
        is_pkg = os.path.isdir(os.path.join(commands_dir, filename)) and \
                 os.path.exists(os.path.join(commands_dir, filename, "__init__.py"))
